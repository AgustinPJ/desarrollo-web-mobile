    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="card shadow-sm p-4 border-0">
                <h3 class="fw-bold text-primary mb-3">Desarrollo web y mobile</h3>
                <p class="lead text-secondary mb-2">En esta asignatura los alumnos/as serán capaces de construir soluciones tecnológicas que involucren plataformas web y aplicaciones móviles como un elemento que cubre problemáticas y necesidades organizacionales, como también dentro de un contexto de innovación y emprendimiento.</p>
            </div>
        </div>
        <!-- footer -->
