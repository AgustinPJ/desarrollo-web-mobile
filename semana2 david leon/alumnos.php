            ...
            <div class="row g-4">
                <div class="col-6">
                    <div class="card shadow-sm h-100 p-2 mb-3 text-center">
                        ...
                        <p class="text-secondary"> Correo: [tu-correo]@uandresbello.edu<br>GitHub: dleonmiranda</p>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card shadow-sm h-100 p-2 mb-3 text-center">
                        <h3 class="text-primary">[Nombre compañero/a]</h3>
                        <div class="text-center">
                            <img src="images.png" alt="avatar logo" style="width:80px;" class="rounded-pill">
                        </div>
                        <p class="text-secondary"> Correo: [correo]@uandresbello.edu<br>GitHub: [usuario-github] </p>
                    </div>
                </div>
            </div>
        </div>
