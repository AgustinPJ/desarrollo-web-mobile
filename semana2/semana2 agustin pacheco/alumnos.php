...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-fluid mt-3">
            <div class="row g-4">
                <div class="col-6">
                    <div class="card shadow-sm h-100 p-2 mb-3 text-center">
                        <h3 class= "text-primary">Agustin Pacheco</h3>
                        <div class="text center">
                            <img src="images.png" alt="avatar logo" style="width:80px;" class="rounded-pill">
                        </div>
                        <p class= text-secondary> Correo: a.pachecojeria@uandresbello.edu<br>GitHub: AgustinPj</p>
                    </div>
                
                </div>
                <div class="col-6">
                    <div class="card shadow-sm h-100 p-2 mb-3 text-center">
                        <h3 class= text-primary>David Leon</h3>
                        <div class="text-center">
                            <img src="images.png" alt="avatar logo" style="width:80px;" class="rounded-pill">
                        </div>
                        <p class= text-secondary> Correo: d.leonmiranda@uandresbello.edu<br>GitHub: dleonmiranda </p>
                    </div>
                </div>
            </div>
