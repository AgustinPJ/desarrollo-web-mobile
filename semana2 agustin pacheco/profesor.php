...
<html lang="es">
    <head>
        <title>Profesor - Desarrollo Web</title>
        <meta charset="utf-8">
    ...
    <body>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-6">
                    <div class="card shadow-sm p-4 mb-5 text-center">
                        <h3 class="text-primary">Ernesto Vivanco</h3>
                        <div class="text-center my-3">
                            <img src="images.png" alt="avatar profesor" style="width:100px;" class="rounded-pill">
                        </div>
                        <p class="text-secondary">
                            correo: e.vivancotapia@uandresbello.edu<br>
                            GitHub: evivanco
                        </p>
                        </div>
                    </div>
        ...
        <div class="container-fluid bg-danger">
            <div class="row">
                <div class="col-12 d-flex justify-content-center py-2" style="color:white">UNAB</div>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Mi Curso</h4>
