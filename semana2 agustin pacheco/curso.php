    ...
    <body>
        ...
        <div class="container-fluid" >
            <div class= "card shadow-sm p-4 border-0">
                ...
                <p class ="lead text-secondary mb-2">En esta asignatura los alumnos/as serán capaces de de construir soluciones tecnológicas que involucren plataformas web y aplicaciones móviles como un elemento que cubre problemáticas y necesidades organizacionales, como también dentro de un contexto de
