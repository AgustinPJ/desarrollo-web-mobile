    ...
    <body>
        ...
        <nav class="navbar navbar-expand-sm bg-danger navbar-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php"><img src="unab.png"alt="Avatar Logo" style="width:40px;" class="rounded-pill"></a>                 <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleNavbar">
        ...
        <div class="container-fluid" >
          Pagina Principal<br>
        <a href="curso.php">Ir a curso</a><br>
        <a href="profesor.php">Ir a profesor</a><br>
        <a href="semana.php">Ir a semanas</a><br>
        <a href="alumnos.php">Ir a alumnos</a><br>
        <!-- footer -->
